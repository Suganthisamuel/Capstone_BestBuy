...
public class UtilityPgm {
	...
	//Initialize the webdriver and web browser
	...
	public static void SwitchWindow() { String
		parentWindow=driver.getWindowHandle(); Set<String>
		windowhandles=driver.getWindowHandles(); windowhandles.size();
