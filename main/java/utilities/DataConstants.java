...
public class DataConstants {
	public static String urlTitle= "Best Buy International: Select your Country - Best Buy";
	public static String urlUSTitle="Best Buy | Official Online Store | Shop Now & Save";
	public static String urlCanadaTitle="Best Buy: Shop Online For Deals & Save | Best Buy Canada";
	...
	public static ArrayList<String> bottomLinkexpTitle = new ArrayList<String>() {
		{add("Accessibility - Best Buy");
		add("BestBuy.com Terms and Conditions");
		...
		add("Best Buy");
		add("Start Request - Best Buy");
		add("California Supply Chain Transparency Act - Best Buy");
		}
	};
}
